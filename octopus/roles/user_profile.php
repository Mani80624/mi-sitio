									...
									<ul class="simple-post-list">
										...
										<li>
											<div class="post-image">
												<div class="img-thumbnail">
													<a href="#">
														<img src="/octopus/assets/images/post-thumb-2.jpg" alt="">
													</a>
												</div>
											</div>
											<div class="post-info">
								...
								<div class="tab-content">
									...
									<div id="edit" class="tab">
										...
										<form class="form-horizontal" id="formUpdate" action="/octopus/principal/php/update.php" method="POST">
											...
											<fieldset>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileBio">Informción biografica</label>
													<div class="col-md-8">
														<textarea class="form-control" rows="3" id="profileBio"></textarea>
													</div>
												</div>
												<div class="form-group">
													<label class="col-xs-3 control-label mt-xs pt-none">Público</label>
													<div class="col-md-8">
